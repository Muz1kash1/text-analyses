...
2) Запустить файл docker-compose `docker-compose up -d --scale textanalyser=3` , если нужно другое количество экземпляров тогда изменить на textanalyser=столько_сколько_вам_нужно
